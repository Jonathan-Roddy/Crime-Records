...
//    
    ///////////////////////////////////////////////////////////////////////////////////
    public static List<Crime> getAllCrimes() throws SQLException{
        
        //my handler will convert rows in the ResultSet to Crime objects and place them in a list
        ResultSetHandler<List<Crime>> handler = new BeanListHandler(Crime.class);
        
        //execute the query and populate the list
        List<Crime> list = runner.query(connection, "SELECT * FROM crime", handler);
        
        return list;
    }//end getAllCrimes
        
    ///////////////////////////////////////////////////////////////////////////////////
    public static List<Crime> getAllCrimesWithMaxQ4() throws SQLException{
        
        //my handler will convert rows in the ResultSet to Crime objects and place them in a list
        ResultSetHandler<List<Crime>> handler = new BeanListHandler(Crime.class);
        
        //execute the query and populate the list
        List<Crime> list = runner.query(connection, "SELECT MAX(Q42018) FROM crime", handler);
